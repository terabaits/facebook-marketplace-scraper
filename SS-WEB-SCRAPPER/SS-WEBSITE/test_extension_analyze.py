...
test_data = {
    ...
    "price": 130,
    "currency": "EUR",
    "listing_url": "https://facebook.com/marketplace/test",
    "image_url": "",
    "seller_location": "Test Location"
}

print("=== Testing Extension API on port 5001 ===")
try:
    r = requests.post(
    ...
    print(f"Error: {e}")
    print("\nIs the extension API server running?")
    print("Run: python facebook-scraper-extension/extension_api.py")
