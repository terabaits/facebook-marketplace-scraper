...
Toggles OFF the Sony filter to show Laowa, Sigma, Tamron, etc.
"""
...
def scrape_all_brands():
    """Scrape all 178 lenses from all brands"""
    
    print("="*70)
    print("Scraping ALL 178 Sony E-mount lenses (all brands)")
    print("="*70)
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            print("\n[2/3] Toggling Sony filter OFF...")
            
            # The Sony button is currently pressed (showing only Sony brand)
            # Click it to toggle OFF and show all brands
            ...
            if sony_btn.count() > 0:
                ...
                if is_pressed == "true":
                    print("  Toggling Sony filter OFF to show all brands...")
                    sony_btn.click()
                    time.sleep(3)
                    ...
                    if results.count() > 0:
                        ...
                        print(f"  New result count: {result_text}")
...
def main():
    try:
        ...
        if lenses:
            ...
            print(f"Other brands: {len(lenses) - sony}")
            print(f"{'='*70}")
